insert into homework4.CUSTOMERS(name, surname, age, phone_number)
...
insert into homework4.ORDERS(date, customers_id, product_name, amount)
...
update homework4.ORDERS
set date='2023.01.11 10.17.15',
    customers_id=4,
    product_name='Печеньки',
    amount=25
where homework4.ORDERS.id = 5;